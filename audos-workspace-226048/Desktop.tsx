...
export default function SpaceDesktop({
  ...
  const rootStyle = {
    ...
    ['--space-font-family' as any]:
      ...
      `"${runtimeTheme.themeTokens.typography?.headingFont || 'Lora'}", Georgia, "Times New Roman", serif`,
    fontFamily:
      runtimeTheme.themeTokens.typography?.fontFamily ||
      `"${runtimeTheme.themeTokens.typography?.headingFont || 'Lora'}", Georgia, "Times New Roman", serif`,
  ...
  return (
    <>
      ...
      {runtimeTheme.themeTokens.typography?.headingFont && (
        <link
          href={`https://fonts.googleapis.com/css2?family=${encodeURIComponent(runtimeTheme.themeTokens.typography.headingFont)}:wght@400;500;600;700&display=swap`}
          rel="stylesheet"
        />
      )}
      ...
      <div className="fixed inset-0 flex overflow-hidden" style={rootStyle}>
        ...
        <div className="flex-1 flex flex-col min-w-0 min-h-0">
          ...
          <div className="flex-1 flex min-w-0 min-h-0 md:gap-3 md:p-3">
            ...
            <main
              className={`flex-1 flex-col min-w-0 min-h-0 overflow-hidden bg-[var(--space-surface-card)] md:rounded-2xl md:shadow-[0_2px_16px_var(--space-shell-shadow),0_1px_3px_var(--space-shell-shadow)] ${
            ...
            {activePanelId && (
              <section
                className={`flex-col min-h-0 overflow-hidden bg-[var(--space-surface-card)] md:flex md:rounded-2xl md:shadow-[0_2px_16px_var(--space-shell-shadow),0_1px_3px_var(--space-shell-shadow)] max-md:flex-1 max-md:min-w-0 ${
