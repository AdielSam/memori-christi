        ...
        <div className="flex-1 overflow-y-auto flex flex-col justify-center">
          <div className="mx-auto w-full max-w-2xl px-6 sm:px-10 py-10" data-testid="home-view">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-semibold text-[var(--space-text-primary)]">
                {agentLabel ? `Hi, I'm ${agentLabel}` : 'How can I help?'}
              </h1>
              {homeWelcomeText && (
          ...
          <div className="mt-8 px-4">
            {isBeaconSpace ? (
              ...
              <div className="text-center text-[var(--space-text-secondary)]">
                ...
                <p className="text-sm">
                  {agentLabel
                    ? `${agentLabel} is here to help you plan gallery walls and choose keepsakes.`
