/**
 * Genesis Space Design System — Memori Christi
 *
 * Cohesive color, typography, and component styles for the genesis shell.
 * All values resolve from --space-* CSS variables injected via config.json.
 */
...
export const semantic = {
  success: {
    50: 'color-mix(in srgb, var(--space-semantic-success) 12%, white)',
    100: 'color-mix(in srgb, var(--space-semantic-success) 18%, white)',
    500: 'var(--space-semantic-success)',
    600: 'var(--space-semantic-success)',
    700: 'color-mix(in srgb, var(--space-semantic-success) 85%, black)',
  },
  warning: {
    50: 'color-mix(in srgb, var(--space-semantic-warning) 12%, white)',
    100: 'color-mix(in srgb, var(--space-semantic-warning) 18%, white)',
    500: 'var(--space-semantic-warning)',
    600: 'var(--space-semantic-warning)',
    700: 'color-mix(in srgb, var(--space-semantic-warning) 85%, black)',
  },
  danger: {
    50: 'color-mix(in srgb, var(--space-semantic-danger) 12%, white)',
    100: 'color-mix(in srgb, var(--space-semantic-danger) 18%, white)',
    500: 'var(--space-semantic-danger)',
    600: 'var(--space-semantic-danger)',
    700: 'color-mix(in srgb, var(--space-semantic-danger) 85%, black)',
  },
} as const;
...
export const neutral = {
  0: 'var(--space-surface-card)',
  50: 'var(--space-surface-muted)',
  100: 'var(--space-surface-accent-soft)',
  200: 'var(--space-border-default)',
  300: 'var(--space-border-strong)',
  400: 'var(--space-text-muted)',
  500: 'var(--space-text-secondary)',
  600: 'var(--space-text-secondary)',
  700: 'var(--space-text-primary)',
  800: 'var(--space-text-brand)',
  900: 'var(--space-text-accent)',
  950: 'var(--space-brand-contrast)',
} as const;
...
export const typography = {
  ...
  fontFamily: 'var(--space-font-family, "Lora", Georgia, "Times New Roman", serif)',
...
export const tw = {
  ...
  button: {
    ...
    primary: 'bg-[var(--space-brand-primary)] hover:brightness-95 text-[var(--space-text-on-primary)] font-medium shadow-[0_4px_14px_var(--space-shell-shadow)] transition-all',
    brand: 'bg-[var(--space-brand-primary)] hover:brightness-95 text-[var(--space-text-on-primary)] font-medium shadow-[0_4px_14px_var(--space-shell-shadow)] transition-all',
    accent: 'bg-[var(--space-brand-highlight)] hover:brightness-95 text-[var(--space-text-on-highlight)] font-medium shadow-[0_4px_14px_var(--space-shell-shadow-strong)] transition-all',
    // Secondary button
  ...
  agent: {
    ...
    fab: 'bg-[var(--space-brand-highlight)] hover:brightness-95 text-[var(--space-text-on-highlight)] shadow-[0_6px_20px_var(--space-shell-shadow-strong)]',
